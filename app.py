...
if active_page == "manifest":
    ...
    if manifest_file is not None:
        try:
            ...
            manifest_file.seek(0)  # re-read the same upload for the full (box-spec-inclusive) parse
            raw_manifest_for_boxes = manifest_intelligence.parse_manifest_full(manifest_file)
