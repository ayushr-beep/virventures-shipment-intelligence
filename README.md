...
- **Premium visual theme**: orange/white/charcoal Virventures brand styling
  throughout — soft-shadow cards, a warm gradient header band, premium
  KPI tiles, and a consistent design language across every tab. Pure CSS
  layered on top of Streamlit (see `modules/theme.py`) — no change to
